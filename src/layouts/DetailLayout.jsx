...
const DetailLayout = () => {
  const { bookingDetails, activeStep, setAgencyFee } = useContext(BookingContext);
    ...
    <div className="container">
      <div className="d-flex justify-content-between align-items-center ">
        ...
        <div className={`step ${activeStep >= 4 ? "active" : ""}`}>
          <span className="step-number">4</span> Billing
        </div>
        <div className={`step ${activeStep >= 5 ? "active" : ""}`}>
          <span className="step-number">5</span> Complete
        </div>
      </div>
        ...
        <div className="col-12 col-md-6">
          ...
          <div className="bg-white p-4 my-3 sticky-top">
            ...
            <div style={{ fontSize: "14px" }}>
              ...
              {bookingDetails.ironing && (
                <p> Ironing : {bookingDetails.ironing}</p>
              )}
              ...
              {bookingDetails.preferedContact && (
                <div className="d-flex align-items-center gap-1">
                  ...
                  <div> {bookingDetails.preferedContact}</div>
                </div>
              )}
              <hr />
            </div>
